...
SubstraitParser::substraitOmniFunctionMap = {
    ...
    {"try_add", {FUNCTION_OMNI_EXPR_TYPE, "try_add"}},
    {"try_subtract", {FUNCTION_OMNI_EXPR_TYPE, "try_subtract"}},
    {"try_multiply", {FUNCTION_OMNI_EXPR_TYPE, "try_multiply"}},
    {"try_divide", {FUNCTION_OMNI_EXPR_TYPE, "try_divide"}},
