 ...
 */
package org.apache.gluten.utils.omni
...
import org.apache.spark.sql.execution.adaptive.omni.OmniAdaptiveQueryExecSuite
...
class OmniTestSettings extends BackendTestSettings {
  // disable tests taht will break the whole UT
  override def shouldRun(suiteName: String, testName: String): Boolean = {
    val preCheck = suiteName.split("[.]").last match {
      case "GlutenCachedTableSuite" =>
        // In the CachedTable scenario, the Omnichannel does not support multiple concurrency in a single process.
        false
      case _ => true
    }
  ...
  enableSuite[GlutenStringFunctionsSuite]
    ...
    // The omni does not support the split method. Therefore, a rollback is performed.
    .exclude("Gluten - string split function with no limit and regex pattern")
    .exclude("Gluten - string split function with limit explicitly set to 0")
  ...
  enableSuite[GlutenDateExpressionsSuite]
    ...
    // https://github.com/facebookincubator/omni/pull/10563/files#diff-140dc50e6dac735f72d29014da44b045509df0dd1737f458de1fe8cfd33d8145
  ...
  enableSuite[GlutenJsonFunctionsSuite]
    // Omni does not support single quotes in get_json_object function.
  ...
  enableSuite[GlutenStringExpressionsSuite]
    .exclude("concat")
  enableSuite[OmniAdaptiveQueryExecSuite]
    .includeByPrefix(
      "gluten",
      "SPARK-29906",
      "SPARK-30291",
  ...
  enableSuite[GlutenDataFrameAggregateSuite]
    .exclude(
      "zero moments", // [omni does not return NaN]
  ...
  enableSuite[GlutenFileBasedDataSourceSuite]
    ...
    // exclude as original metric not correct when task offloaded to omni
  ...
  override def getSQLQueryTestSettings: SQLQueryTestSettings = OmniSQLQueryTestSettings
}
