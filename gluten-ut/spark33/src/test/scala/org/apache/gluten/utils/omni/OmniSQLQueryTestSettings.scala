...
object OmniSQLQueryTestSettings extends SQLQueryTestSettings {
  ...
  private val SUPPORTED_SQL_QUERY_LIST: Set[String] = Set(
    ...
    // Omni had different handling for some illegal cases.
  ...
  private val OVERWRITE_SQL_QUERY_LIST: Set[String] = Set(
    // The calculation formulas for corr, skewness, kurtosis, variance, and stddev in Omni differ
