...
object OmniExpressionAdaptor extends Logging {
  ...
  def getExprIdMap(inputAttrs: Seq[Attribute]): Map[ExprId, Int] = {
    inputAttrs.iterator.zipWithIndex.map { case (attr, idx) => attr.exprId -> idx }.toMap
  }
  ...
  def rewriteToOmniJsonExpressionLiteral(
      expr: Expression,
    ...
    expr match {
      ...
      case unscaledValue: UnscaledValue =>
        new JsonObject()
          ...
          .put(
            "arguments",
            new JsonArray().put(
              rewriteToOmniJsonExpressionLiteralJsonObject(unscaledValue.child, exprsIndexMap)))
          ...
          case decimalChild: DecimalType =>
            new JsonObject()
              ...
              .put(
                "arguments",
                new JsonArray().put(
                  rewriteToOmniJsonExpressionLiteralJsonObject(makeDecimal.child, exprsIndexMap)))
      ...
      case greaterThan: GreaterThan =>
        new JsonObject()
          ...
          .put(
            "left",
            rewriteToOmniJsonExpressionLiteralJsonObject(greaterThan.left, exprsIndexMap))
          .put(
            "right",
            rewriteToOmniJsonExpressionLiteralJsonObject(greaterThan.right, exprsIndexMap))
      ...
      case greaterThanOrEq: GreaterThanOrEqual =>
        new JsonObject()
          ...
          .put(
            "left",
            rewriteToOmniJsonExpressionLiteralJsonObject(greaterThanOrEq.left, exprsIndexMap))
          .put(
            "right",
            rewriteToOmniJsonExpressionLiteralJsonObject(greaterThanOrEq.right, exprsIndexMap))
      ...
      case lessThanOrEq: LessThanOrEqual =>
        new JsonObject()
          ...
          .put(
            "left",
            rewriteToOmniJsonExpressionLiteralJsonObject(lessThanOrEq.left, exprsIndexMap))
          .put(
            "right",
            rewriteToOmniJsonExpressionLiteralJsonObject(lessThanOrEq.right, exprsIndexMap))
        ...
        not.child match {
          ...
          case equal: EqualTo =>
            new JsonObject()
              ...
              .put(
                "right",
                rewriteToOmniJsonExpressionLiteralJsonObject(equal.right, exprsIndexMap))
          ...
          .put(
            ...
            new JsonObject()
              ...
              .put(
                "arguments",
                new JsonArray().put(
                  rewriteToOmniJsonExpressionLiteralJsonObject(isnotnull.child, exprsIndexMap)))
          )
      ...
      case isNull: IsNull =>
        new JsonObject()
          ...
          .put(
            "arguments",
            new JsonArray().put(
              rewriteToOmniJsonExpressionLiteralJsonObject(isNull.child, exprsIndexMap)))
          .addOmniExpJsonType("returnType", BooleanType)
      ...
      case subString: Substring =>
        new JsonObject()
          ...
          .put(
            "arguments",
            new JsonArray()
              .put(rewriteToOmniJsonExpressionLiteralJsonObject(subString.str, exprsIndexMap))
...
//      // Cast
      ...
      case abs: Abs =>
        new JsonObject()
          ...
          .put(
            "arguments",
            new JsonArray().put(
              rewriteToOmniJsonExpressionLiteralJsonObject(abs.child, exprsIndexMap)))
      ...
      case lower: Lower =>
        new JsonObject()
          ...
          .put(
            "arguments",
            new JsonArray().put(
              rewriteToOmniJsonExpressionLiteralJsonObject(lower.child, exprsIndexMap)))
      ...
      case length: Length =>
        new JsonObject()
          ...
          .put(
            "arguments",
            new JsonArray().put(
              rewriteToOmniJsonExpressionLiteralJsonObject(length.child, exprsIndexMap)))
      ...
      case replace: StringReplace =>
        new JsonObject()
          ...
          .put(
            "arguments",
            new JsonArray()
              .put(rewriteToOmniJsonExpressionLiteralJsonObject(replace.srcExpr, exprsIndexMap))
      ...
      case in: In =>
        new JsonObject()
          ...
          .put(
            "arguments",
            new JsonArray().addFromArray(
              in.children
                .map(child => rewriteToOmniJsonExpressionLiteralJsonObject(child, exprsIndexMap))
                .toArray))
      ...
      case inSet: InSet =>
        ...
        val jsonArray = new JsonArray().put(
          rewriteToOmniJsonExpressionLiteralJsonObject(inSet.child, exprsIndexMap))
        inSet.set.foreach(
          child => jsonArray.put(toOmniJsonLiteral(Literal(child, inSet.child.dataType))))
      ...
      case ifExp: If =>
        new JsonObject()
          ...
          .put(
            "condition",
            rewriteToOmniJsonExpressionLiteralJsonObject(ifExp.predicate, exprsIndexMap))
          .put(
            "if_true",
            rewriteToOmniJsonExpressionLiteralJsonObject(ifExp.trueValue, exprsIndexMap))
          .put(
            "if_false",
            rewriteToOmniJsonExpressionLiteralJsonObject(ifExp.falseValue, exprsIndexMap))
      ...
      case round: Round =>
        new JsonObject()
          ...
          .put(
            "arguments",
            new JsonArray()
              .put(rewriteToOmniJsonExpressionLiteralJsonObject(round.child, exprsIndexMap))
      ...
      case inStr: StringInstr =>
        new JsonObject()
          ...
          .put(
            "arguments",
            new JsonArray()
              .put(rewriteToOmniJsonExpressionLiteralJsonObject(inStr.str, exprsIndexMap))
      ...
      case rlike: RLike =>
        new JsonObject()
          ...
          .put(
            "arguments",
            new JsonArray()
              .put(rewriteToOmniJsonExpressionLiteralJsonObject(rlike.left, exprsIndexMap))
      ...
      case unixTimestamp: UnixTimestamp =>
        ...
        new JsonObject()
          ...
          .put(
            ...
            new JsonArray()
              .put(
                rewriteToOmniJsonExpressionLiteralJsonObject(unixTimestamp.timeExp, exprsIndexMap))
              .put(new JsonParser().parse(toOmniTimeFormat(
                rewriteToOmniJsonExpressionLiteral(unixTimestamp.format, exprsIndexMap))))
              .put(
                new JsonObject()
                  .put("exprType", "LITERAL")
                  .put("dataType", 15)
          ...
          case literal: Literal =>
            new JsonObject()
              ...
              .put(
                "arguments",
                new JsonArray()
                  .put(rewriteToOmniJsonExpressionLiteralJsonObject(startsWith.left, exprsIndexMap))
                  .put(
                    rewriteToOmniJsonExpressionLiteralJsonObject(startsWith.right, exprsIndexMap))
              )

          case _ =>
            throw new UnsupportedOperationException(
              s"Unsupported right expression in like expression: $startsWith")
        }
          ...
          case literal: Literal =>
            new JsonObject()
              ...
              .put(
                "arguments",
                new JsonArray()
                  .put(rewriteToOmniJsonExpressionLiteralJsonObject(endsWith.left, exprsIndexMap))
                  .put(rewriteToOmniJsonExpressionLiteralJsonObject(endsWith.right, exprsIndexMap))
              )

          case _ =>
            throw new UnsupportedOperationException(
              s"Unsupported right expression in like expression: $endsWith")
        }
      case contains: Contains =>
        contains.children.map(_.dataType).foreach {
          ...
          case dataType =>
            throw new UnsupportedOperationException(
              s"Invalid input dataType:$dataType for contains")
        }
        new JsonObject()
          .put("exprType", "FUNCTION")
          ...
          .put(
            "arguments",
            new JsonArray()
              .put(rewriteToOmniJsonExpressionLiteralJsonObject(contains.left, exprsIndexMap))
      ...
      case truncDate: TruncDate =>
        new JsonObject()
          ...
          .put(
            "arguments",
            new JsonArray()
              .put(rewriteToOmniJsonExpressionLiteralJsonObject(truncDate.left, exprsIndexMap))
      ...
      case _ =>
        // TODO: Handle udf
//        val jsonObj = ModifyUtilAdaptor.rewriteToOmniJsonExpression(
//          expr, exprsIndexMap, returnDatatype, rewriteToOmniJsonExpressionLiteralJsonObject)
//        if (jsonObj != null) {
//          return jsonObj
//        }
//        if (HiveUdfAdaptorUtil.isHiveUdf(expr) &&
//          ColumnarPluginConfig.getSessionConf.enableColumnarUdf) {
...
//            .put("arguments", g
//              etJsonExprArgumentsByChildren(hiveUdf.children, exprsIndexMap))
//        }
        throw new UnsupportedOperationException(s"Unsupported expression: $expr")
    }
  }
  ...
  private def getConcatJsonStr(concat: Concat, exprsIndexMap: Map[ExprId, Int]): JsonObject = {
    ...
    val res = new JsonObject()
      ...
      .put(
        "arguments",
        new JsonArray()
          .put(rewriteToOmniJsonExpressionLiteralJsonObject(children.head, exprsIndexMap))
  ...
  private def getGreatestJsonStr(
      greatest: Greatest,
      exprsIndexMap: Map[ExprId, Int]): JsonObject = {
    if (greatest.children.length != 2) {
      throw new UnsupportedOperationException(
        s"Number of parameters is ${greatest.children.length}. " +
...
//    }
  ...
  private def genMurMur3HashExpr(
  ...
  private val REGR_AGG_CLASS_NAMES = Set(
    ...
    "org.apache.spark.sql.catalyst.expressions.aggregate.RegrCount",
  ...
  def toOmniAggFunType(
    ...
    agg.aggregateFunction match {
      ...
      case aggFunc if aggFunc.getClass.getName ==
          "org.apache.spark.sql.catalyst.expressions.aggregate.BloomFilterAggregate" =>
        OMNI_AGGREGATION_TYPE_BLOOM_FILTER
      ...
      case _: CollectList => OMNI_AGGREGATION_TYPE_COLLECT_LIST
  ...
  def toOmniWindowFunType(window: Expression): FunctionType = {
    window match {
      ...
      case DenseRank(_) => OMNI_WINDOW_TYPE_DENSE_RANK
  ...
  def toOmniAggInOutJSonExp(
      attribute: Seq[Expression],
      exprsIndexMap: Map[ExprId, Int]): Array[String] = {
    attribute.map(attr => rewriteToOmniJsonExpressionLiteral(attr, exprsIndexMap)).toArray
  }

  def toOmniAggInOutType(
      attribute: Seq[AttributeReference]): Array[nova.hetu.omniruntime.`type`.DataType] = {
    attribute.map(attr => sparkTypeToOmniType(attr.dataType, attr.metadata)).toArray
  }

  def toOmniAggInOutType(
      dataType: DataType,
      metadata: Metadata = Metadata.empty): Array[nova.hetu.omniruntime.`type`.DataType] = {
  ...
  def sparkProjectionToOmniJsonProjection(attr: Attribute, colVal: Int): String = {
    ...
    dataType match {
      case ByteType | ShortType | IntegerType | LongType | DoubleType | FloatType | BooleanType |
          DateType | TimestampType | StructType(_) | MapType(_, _, _) | ArrayType(_, _) =>
        new JsonObject()
          .put("exprType", "FIELD_REFERENCE")
          .put("dataType", omniDataType.toInt)
          .put("colVal", colVal)
  ...
  def procCaseWhenExpression(caseWhen: CaseWhen, exprsIndexMap: Map[ExprId, Int]): JsonObject = {
    var jsonObject = new JsonObject()
    for (i <- caseWhen.branches.indices.reverse) {
      val outerJson = new JsonObject()
        .put("exprType", "IF")
        .addOmniExpJsonType("returnType", caseWhen.dataType)
        .put(
          "condition",
          rewriteToOmniJsonExpressionLiteralJsonObject(caseWhen.branches(i)._1, exprsIndexMap))
        .put(
          "if_true",
          rewriteToOmniJsonExpressionLiteralJsonObject(caseWhen.branches(i)._2, exprsIndexMap))
      ...
      if (i != caseWhen.branches.length - 1) {
        ...
        outerJson.put(
          "if_false",
          rewriteToOmniJsonExpressionLiteralJsonObject(elseValue.get, exprsIndexMap))
      }
  ...
  def toOmniBuildSide(buildSide: BuildSide): nova.hetu.omniruntime.constants.BuildSide = {
    buildSide match {
      case BuildLeft =>
        BUILD_LEFT
      case BuildRight =>
        BUILD_RIGHT
      case _ =>
        throw new UnsupportedOperationException(s"Build-Side[$buildSide] is not supported.")
    }
  }
  ...
  def isSimpleColumn(expr: String): Boolean = {
    ...
    if (
      indexOfExprType != -1 && indexOfExprType == lastIndexOfExprType
  ...
  def isAllSimpleExpression(exprs: Seq[Expression]): Boolean = {
    for (expr <- exprs) {
  ...
  def getExprIdFromExpressions(exprs: Seq[Expression]): ArrayBuffer[ExprId] = {
    var ret = ArrayBuffer[ExprId]()
    for (expr <- exprs) {
      expr match {
        case attributeReference: AttributeReference =>
          ret += attributeReference.exprId
        case alias: Alias =>
          alias.child match {
            case attr: AttributeReference => ret += attr.exprId
            case _ =>
              throw new UnsupportedOperationException(s"Unsupported Expression")
          }
        case _ =>
          throw new UnsupportedOperationException(s"Unsupported Expression")
      }
