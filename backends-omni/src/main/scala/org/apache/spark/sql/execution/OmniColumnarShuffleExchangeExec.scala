...
case class OmniColumnarShuffleExchangeExec(
  ...
  protected def withNewChildInternal(newChild: SparkPlan): OmniColumnarShuffleExchangeExec =
    copy(child = newChild)
}

object OmniColumnarShuffleExchangeExec extends Logging {

  def apply(
      plan: ShuffleExchangeExec,
      child: SparkPlan,
      shuffleOutputAttributes: Seq[Attribute],
      handleRow: Boolean): OmniColumnarShuffleExchangeExec = {
