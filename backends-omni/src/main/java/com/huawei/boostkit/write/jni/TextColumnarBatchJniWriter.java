...
/**
 * JNI bridge for the native Text columnar writer.
 *
 * @since 2026/08/28
 */
public class TextColumnarBatchJniWriter {
    /**
     * Initializes a native Text writer.
     *
     * @param options native writer options
